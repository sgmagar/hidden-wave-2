"""
Django settings for hidden_wave_2 project.
...
ROOT_URLCONF = 'hidden_wave_2.urls'
...
WSGI_APPLICATION = 'hidden_wave_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_wave_2 API",
    "DESCRIPTION": "API documentation for hidden_wave_2 App",
    "VERSION": "v1",
}
